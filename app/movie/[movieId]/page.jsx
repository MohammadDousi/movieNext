    ...
    <>
      <section className="w-full px-6 lg:px-16 relative h-full min-h-screen flex flex-col justify-start items-center gap-10 lg:gap-16 overflow-x-hidden">
        ...
        {dataMovie?.data != ("" || null) ? (
            ...
            <div className="w-full lg:w-3/4 mt-5 flex flex-col justify-start items-start gap-6">
              <div className="w-full lg:w-auto flex flex-row flex-wrap justify-center lg:justify-start items-center gap-2 lg:gap-6">
                ...
                <h3 className="text-base text-textColor/70 drop-shadow-lg flex flex-row justify-center items-center gap-1.5">
                  ...
                  {dataMovie?.data?.production_countries?.map(
                    (counters, index) =>
                      index + Number(1) ===
          ...
          <section className="w-full h-full lg:h-full min-h-screen z-10 relative lg:pt-24 flex flex-col lg:flex-row justify-start lg:justify-center items-center gap-10">
            <div className="skeleton opacity-25 bg-textColor/25 w-3/5 lg:w-1/4 h-80 lg:h-[30rem] rounded-xl"></div>

            <div className="w-full lg:w-3/4 mt-5 flex flex-col justify-start items-start gap-10">
              <div className="w-full lg:w-full flex flex-row flex-wrap justify-center lg:justify-start items-center gap-2 lg:gap-6">
                <div className="skeleton opacity-25 bg-textColor/25 w-1/5 lg:w-1/6 h-3 rounded-xl"></div>
                <div className="skeleton opacity-25 bg-textColor/25 w-1/5 lg:w-1/6 h-3 rounded-xl"></div>
                <div className="skeleton opacity-25 bg-textColor/25 w-1/5 lg:w-1/6 h-3 rounded-xl"></div>
              </div>

              <div className="w-full flex flex-col justify-start items-start gap-8">
                <div className="skeleton opacity-25 bg-textColor/25 w-full lg:w-2/3 h-3 rounded-xl"></div>

                <div className="w-full flex flex-col justify-start items-start gap-4">
                  <div className="skeleton opacity-25 bg-textColor/25 w-1/2 lg:w-1/2 h-3 rounded-xl"></div>
                  <div className="skeleton opacity-25 bg-textColor/25 w-1/2 lg:w-1/2 h-3 rounded-xl"></div>
                  <div className="skeleton opacity-25 bg-textColor/25 w-1/2 lg:w-1/2 h-3 rounded-xl"></div>
                  <div className="skeleton opacity-25 bg-textColor/25 w-1/2 lg:w-1/3 h-3 rounded-xl"></div>
                </div>
              </div>

              <div className="w-full flex flex-col justify-start items-start gap-6">
                <div className="w-full lg:w-full flex flex-row flex-wrap justify-center lg:justify-start items-center gap-2 lg:gap-6">
                  <div className="skeleton opacity-25 bg-textColor/25 w-1/5 lg:w-1/12 h-3 rounded-xl"></div>
                  <div className="skeleton opacity-25 bg-textColor/25 w-1/5 lg:w-1/12 h-3 rounded-xl"></div>
                  <div className="skeleton opacity-25 bg-textColor/25 w-1/5 lg:w-1/12 h-3 rounded-xl"></div>
                </div>
